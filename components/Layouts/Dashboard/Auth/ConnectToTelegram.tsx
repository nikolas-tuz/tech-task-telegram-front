...
export default function ConnectToTelegram({ className, onTelegramConnect, ...props }: ConnectToTelegramType) {
  return (
    <>
      <DivContainer {...props} className={`text-center flex flex-col items-center justify-center ${className}`}>
        ...
        <DivContainer className={`w-full`}>
          <Button onClick={onTelegramConnect} className={`w-full`}>Log In Onto Telegram</Button>
        </DivContainer>
      </DivContainer>
    </>
  );
