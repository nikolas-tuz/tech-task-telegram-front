...
export default function RegisterOntoSystem({ setAuthState }: RegisterOntoSystemType) {
  return (
    <>
      <DivContainer className={`text-center flex flex-col items-center justify-center`}>
        ...
        <DivContainer className={`w-full flex flex-col gap-3`}>
          ...
          <button className={`cursor-pointer transition-all duration-200 hover:scale-105`} onClick={() => setAuthState(`login`)}>
